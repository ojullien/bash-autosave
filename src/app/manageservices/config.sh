...
readonly m_SERVICES_STOP="apache2 fail2ban php7.3-fpm php7.2-fpm php5.6-fpm mysql"
readonly m_SERVICES_START="mysql php7.3-fpm php7.2-fpm php5.6-fpm apache2 fail2ban"
